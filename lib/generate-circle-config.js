      ...
      steps: [
        ...
        },
        {
          run: {
            ...
            command: `$(npm bin)/cypress run --spec cypress/integration/examples/${value}`
          }
        },
        {
          store_artifacts: {
...
console.log(path.join(__dirname, "circle.json"));

// get spec files as an array
const files = fs
  .readdirSync(path.join(__dirname, "..", "cypress", "integration", "examples"))
